...
COMMENT = 'AI-powered analytics agent for Salesforce Marketing Cloud email campaign performance.'
AS '
...
tools:
  ...
  - tool_spec:
      ...
      cortex_search_service: MARKETING_DOCS_SEARCH
...
GRANT USAGE ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-DEV-MARCOM-APP-DIRECTMARKETING-ETL-SG";
GRANT OWNERSHIP ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-DEV-MARCOM-APP-DIRECTMARKETING-ETL-SG";

GRANT USAGE ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-DEV-MARCOM-APP-DIRECTMARKETING-ANALYST-SG";
GRANT MONITOR ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-DEV-MARCOM-APP-DIRECTMARKETING-ANALYST-SG";

-- PROD Environment Roles (If deploying to PROD, or strictly for cross-env access testing)
GRANT USAGE ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-PROD-MARCOM-APP-DIRECTMARKETING-ANALYST-SG";
-- GRANT USAGE ON AGENT PLAYGROUND_LM.CORTEX_ANALYTICS_ORCHESTRATOR.DIRECT_MARKETING_ANALYTICS_AGENT TO ROLE "CLD-SNOWFLAKE-PROD-MARCOM-APP-DIRECTMARKETING-ETL-SG";
